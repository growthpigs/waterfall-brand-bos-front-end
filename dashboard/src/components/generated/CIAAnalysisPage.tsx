...
const CIAAnalysisPage: React.FC<CIAAnalysisPageProps> = ({ onNavigate }) => {
  ...
  return <div className="flex h-screen w-full overflow-hidden">
      ...
      {/* Left Sidebar */}
      <SidebarNavigation onNavigate={onNavigate} activePageId="cia" />
              ...
              display: "none"
                ...
                <div className="mb-3">
                  ...
                  <p className="text-sm text-white/70">
                    Ask about analysis progress, request specific insights, or get help with intelligence gathering
                  </p>
                </div>
                <PersistentChatBar onSendMessage={handleSendMessage} placeholder="Ask about analysis progress or request specific intelligence..." />
              </div>
            </motion.div>
          </motion.div>
        </div>
