...
const MetricCard: React.FC<MetricCardProps> = ({ title, value, status, delay = 0 }) => {
  return (
    <motion.div
      initial={{
        opacity: 0,
...
const WideCard: React.FC<WideCardProps> = ({ title, subtitle, content, delay = 0 }) => {
  return (
    <motion.div
      initial={{
        opacity: 0,
...
const BrandBOSOverviewDashboard: React.FC = () => {
  ...
  const performanceChart = (
    <div className="h-32 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl flex items-center justify-center">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className={`w-full flex items-center px-4 py-3 rounded-xl text-left transition-all duration-200 ${isActive ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-white/70 hover:text-white hover:bg-white/10'}`}
                    >
              ...
              <form onSubmit={handleSendMessage} className="relative">
                <div className="flex items-center glass-card overflow-hidden">
                  <input
                    ...
                    className="flex-1 px-6 py-4 text-white placeholder-white/60 bg-transparent border-none outline-none"
                  />
                  <button
                    type="submit"
