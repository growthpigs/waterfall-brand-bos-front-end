...
import { FileText, Calendar, Rocket, BarChart3, Settings, Home, Target, Shield, Brain, TrendingUp, Zap, Users, Clock, Play, Edit3, Mail, Globe, Sparkles, CheckCircle, ArrowRight, Plus } from 'lucide-react';
...
const ContentEngineWorkspace: React.FC<ContentEngineWorkspaceProps> = ({ onNavigate }) => {
  ...
  return <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-900 -z-10" />
      
      {/* Left Sidebar */}
      <aside className="w-80 flex flex-col relative">
        {/* Glassmorphic overlay for sidebar */}
        <div className="absolute inset-0 bg-indigo-900/40 backdrop-blur-md border-r border-white/20" />
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <nav className="flex-1 p-6">
            ...
            height: "690px"
              ...
              <li>
                <button className="w-full flex items-center px-4 py-3 rounded-xl text-left transition-all duration-200 text-white/70 hover:text-white hover:bg-white/10" style={{
                paddingBottom: "22px"
              }}>
              ...
              <li>
                ...
                paddingBottom: "22px"
                  ...
                  <span className="font-medium">CIA Analysis</span>
                </button>
              </li>
              <li>
                <button className="w-full flex items-center px-4 py-3 rounded-xl text-left transition-all duration-200 bg-white/20 text-white shadow-lg backdrop-blur-sm" style={{
                paddingBottom: "22px"
              }}>
              ...
              <li>
                ...
                paddingBottom: "22px"
                  ...
                  <span className="font-medium">Campaign Center</span>
                </button>
              </li>
              <li>
                <button className="w-full flex items-center px-4 py-3 rounded-xl text-left transition-all duration-200 text-white/70 hover:text-white hover:bg-white/10" style={{
        ...
        <div className="flex-1 pl-0 pr-8 pt-12 pb-8 overflow-auto">
          ...
          duration: 0.6
            ...
            <div className="mb-8">
              ...
              duration: 0.7,
              delay: 0.2
            }} className="text-4xl font-bold text-white mb-3 drop-shadow-lg leading-tight">Brand BOS Dashboard</motion.h1>
              <motion.p initial={{
              opacity: 0,
              x: -20
            }} animate={{
                ...
                return <motion.div key={card.id} initial={{
                  ...
                  delay: 0.1 * index
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {card.count && <span className="text-2xl font-bold text-white">{card.count}</span>}
                      </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl">
                  ...
                  <div className="space-y-4">
                    {activeProjects.map((project, index) => <motion.div key={project.id} initial={{
                    opacity: 0,
                    x: -20
                  }} animate={{
                    opacity: 1,
                    ...
                    duration: 0.4,
                    delay: 0.1 * index
                  }} className="bg-white/10 rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 cursor-pointer" onClick={() => setSelectedProject(project.id)}>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1 mr-4">
                            <div className="w-full bg-white/20 rounded-full h-2">
                              <div className="bg-purple-400 h-2 rounded-full transition-all duration-500" style={{
            ...
            delay: 0.6
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                return <motion.button key={action.id} initial={{
                  opacity: 0,
                  y: 20
                }} animate={{
                  opacity: 1,
            ...
            delay: 0.7
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 border border-white/20 shadow-xl overflow-hidden">
                ...
                ease: "linear"
                  ...
                  ✍️ 47 pieces generated this week • 🎯 3 viral posts identified • 📈 Content ROI up 240% • 🚀 New template available • ✍️ 47 pieces generated this week • 🎯 3 viral posts identified • 📈 Content ROI up 240% • 🚀 New template available
                </motion.div>
              </div>
            </motion.div>
            ...
            delay: 0.8
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 border border-white/20 shadow-2xl" style={{
              display: "none"
            }}>
                <div className="mb-3">
                ...
                <PersistentChatBar onSendMessage={handleSendMessage} placeholder="Ask about content strategy, request specific content, or get writing help..." />
              </div>
            </motion.div>
          </motion.div>
        </div>
