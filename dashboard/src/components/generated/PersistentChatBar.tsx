    ...
    <div className="w-full">
      <form onSubmit={handleSubmit} className="relative">
        <motion.div
          animate={{
            boxShadow: isFocused
              ? '0 0 0 2px rgb(255 255 255 / 0.3), 0 8px 32px rgb(0 0 0 / 0.2)'
              : '0 4px 16px rgb(0 0 0 / 0.1)',
          }}
          transition={{
            duration: 0.2,
          }}
          className="flex items-center glass-card overflow-hidden"
          style={{
            flexWrap: 'nowrap',
            rowGap: '0px',
            alignItems: 'center',
        ...
        >
          ...
          <input
            ...
            className="flex-1 px-2 py-4 text-white placeholder-white/60 bg-transparent border-none outline-none resize-none"
          />
