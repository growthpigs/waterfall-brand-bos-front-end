...
const CampaignCenterPage: React.FC<CampaignCenterPageProps> = ({ onNavigate }) => {
  ...
  return (
    <ProfessionalLayout
      theme="blue"
      sidebar={<ProfessionalSidebarNavigation onNavigate={onNavigate} activePageId="campaigns" />}
    >
      {/* Main Content Area */}
      {/* Fixed Gradient Background */}
      <div className="fixed inset-0 bg-gradient-to-br from-pink-600 via-pink-700 to-pink-800" />
      ...
      <div className="flex-1 pl-0 pr-8 pt-8 overflow-auto">
        ...
        >
          ...
          <header className="mb-6">
            <h1 className="text-3xl font-bold text-white mb-1 drop-shadow-lg pl-6 leading-tight">
              Campaign Center
            </h1>
              ...
              <div className="space-y-1">
                <div className="flex justify-between leading-tight">
                  ...
                  <span className="text-white font-medium">
                    {dashboardMetrics.contentClusters.activeCampaigns}
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Weekly Reach:</span>
                  <span className="text-white font-medium">
                    {(dashboardMetrics.contentClusters.weeklyReach / 1000).toFixed(0)}K
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Engagement:</span>
                  <span className="text-white font-medium">
                    {dashboardMetrics.contentClusters.engagementRate}%
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-1">
                <div className="flex justify-between leading-tight">
                  ...
                  <span className="text-white font-medium">
                    ${dashboardMetrics.googleGrant.totalBudget.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Allocated:</span>
                  <span className="text-white font-medium">
                    ${dashboardMetrics.googleGrant.allocated.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Efficiency:</span>
                  <span className="text-white font-medium">
                    {dashboardMetrics.googleGrant.efficiency}%
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-1">
                <div className="flex justify-between leading-tight">
                  ...
                  <span className="text-white font-medium">
                    {dashboardMetrics.humbleboastBriefs.generated}
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Ready:</span>
                  <span className="text-white font-medium">
                    {dashboardMetrics.humbleboastBriefs.readyForFacebook}
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Est. Reach:</span>
                  <span className="text-white font-medium">
                    {(dashboardMetrics.humbleboastBriefs.estimatedReach / 1000).toFixed(0)}K
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-1">
                <div className="flex justify-between leading-tight">
                  ...
                  <span className="text-white font-medium">
                    {dashboardMetrics.authorityScore.current}/100
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Weekly:</span>
                  <span className="text-white font-medium">
                    +{dashboardMetrics.authorityScore.weeklyGrowth}%
                  </span>
                </div>
                <div className="flex justify-between leading-tight">
                  <span className="text-white/80">Ranking:</span>
                  <span className="text-white font-medium">
                    {dashboardMetrics.authorityScore.industryRanking}
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          >
            <div className="flex flex-wrap gap-4 items-center justify-between">
              <div className="flex flex-wrap gap-3">
                <button
                  className="flex items-center px-6 py-3 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-medium transition-all duration-200 hover:scale-105 shadow-professional hover:shadow-professional-lg"
                  style={{
                    color: '#ed5927',
                  }}
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <span
                          className={`inline-block px-2 py-1 rounded-lg text-xs font-medium border ${getStatusColor(campaign.status)}`}
                        >
                      ...
                      {campaign.type === 'content-cluster' && (
                        <>
                          <div className="flex justify-between text-sm leading-tight">
                            ...
                            <span className="text-white">${campaign.metrics.budget}</span>
                          </div>
                          <div className="flex justify-between text-sm leading-tight">
                      ...
                      {campaign.type === 'humbleboast' && (
                        <>
                          <div className="flex justify-between text-sm leading-tight">
                            ...
                            <span className="text-white">Ready for Facebook</span>
                          </div>
                          <div className="flex justify-between text-sm leading-tight">
                          ...
                          <div className="flex justify-between text-sm leading-tight">
                            ...
                            <span className="text-white font-medium">
                              {campaign.description?.includes('Testimonial')
                                ? 'Testimonial'
                                : 'Authority'}
                            </span>
                          </div>
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white text-sm leading-tight">
                      New CIA intelligence available for campaign optimization
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white text-sm leading-tight">
                      Google Ad Grant budget rotation recommended
                    </p>
                    <p className="text-white/70 text-xs leading-tight">
                      Optimize for Q1 performance
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white text-sm leading-tight">
                      Content Cluster #3 exceeding performance targets
                    </p>
                    <p className="text-white/70 text-xs leading-tight">
                      Consider scaling budget allocation
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 pb-6">
            <PersistentChatBar
              ...
              placeholder="Ask Campaign Assistant about Brand BOS strategies…"
            />
          </div>
        </motion.div>
      </div>
