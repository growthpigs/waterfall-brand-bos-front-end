        ...
        >
          ...
          >
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 border border-white/20 shadow-2xl">
              <div className="mb-3">
                <h3 className="text-lg font-semibold text-white/90 mb-1">AI Assistant</h3>
                <p className="text-sm text-white/70">
                  Ask me anything about your brand performance, content strategy, or campaign
                  optimization
                </p>
              </div>
              <PersistentChatBar
                onSendMessage={handleSendMessage}
                placeholder="Ask Brand BOS anything about your performance..."
              />
            </div>
          </motion.div>
        </motion.div>
