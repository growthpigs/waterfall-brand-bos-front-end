...
const PerformancePage: React.FC<PerformancePageProps> = ({ onNavigate }) => {
  ...
  const getTrendIcon = (trend: 'up' | 'down' | 'stable') => {
    switch (trend) {
      case 'up':
        return <ArrowUp className="w-4 h-4 text-green-400" style={{
          borderWidth: "0px",
          borderStyle: "solid",
  ...
  return <div className="flex h-screen w-full overflow-hidden">
      ...
      {/* Left Sidebar */}
      <SidebarNavigation onNavigate={onNavigate} activePageId="performance" />
          ...
          duration: 0.6
            ...
            <div className="mb-8 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <select value={selectedTimeRange} onChange={e => setSelectedTimeRange(e.target.value)} className="bg-white/20 backdrop-blur-md border border-white/30 rounded-xl px-4 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-white/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              return <motion.div key={metric.id} initial={{
                ...
                duration: 0.6,
                delay: index * 0.1
              }} className="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl p-6 hover:bg-white/25 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              delay: 0.3
                ...
                <div className="space-y-4">
                  {platformMetrics.map(platform => <div key={platform.platform} className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-white text-sm font-medium">{formatNumber(platform.followers)} followers</div>
                        <div className="text-white/60 text-xs">{platform.engagement}% engagement</div>
                      </div>
                    </div>)}
                </div>
              </motion.div>
              ...
              delay: 0.4
                ...
                <h3 className="text-white text-xl font-semibold mb-4">Content Generation Pipeline</h3>
            ...
            duration: 0.6,
            delay: 0.5
          }} className="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl p-6 mb-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-white text-xl font-semibold">Brand BOS Content Performance</h3>
                <div className="flex items-center gap-3">
                  <select value={sortBy} onChange={e => setSortBy(e.target.value)} className="bg-white/20 backdrop-blur-md border border-white/30 rounded-lg px-3 py-1 text-white text-sm focus:outline-none focus:ring-2 focus:ring-white/50">
                    <option value="engagement" className="bg-gray-800">Sort by Engagement</option>
                    <option value="status" className="bg-gray-800">Sort by Status</option>
                    <option value="format" className="bg-gray-800">Sort by Format</option>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-white/20">
                      <th className="text-left text-white/70 text-sm font-medium py-3">Content Cluster</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">Format Type</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">Publishing Status</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">Social Engagement</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">CIA Score</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">Authority Impact</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">Cross-Platform</th>
                      <th className="text-left text-white/70 text-sm font-medium py-3">Approval Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {contentPerformance.map(content => <tr key={content.id} className="border-b border-white/10 hover:bg-white/10 transition-colors">
                        <td className="py-4">
                        ...
                        <td className="py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-white/80 text-sm">{content.publishingStatus}</span>
                          </div>
                        </td>
                        <td className="py-4">
                        ...
                        <td className="py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-sm font-medium ${getCiaScoreColor(content.ciaScore)}`}>{content.ciaScore}/10</span>
                          </div>
                        </td>
                        <td className="py-4">
                          <span className={`text-sm font-medium ${getAuthorityImpactColor(content.authorityImpact)}`}>{content.authorityImpact}</span>
                        </td>
                        <td className="py-4">
                          <span className="text-gray-400 text-sm">{content.crossPlatformPerformance}</span>
                        </td>
                        <td className="py-4">
                          <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              duration: 0.6,
              delay: 0.6
            }} className="bg-gray-500/20 backdrop-blur-md border border-gray-400/30 rounded-2xl p-6">
                <div className="text-center">
                  <div className="w-16 h-16 bg-gray-400/30 rounded-full flex items-center justify-center mx-auto mb-4">
                    <TrendingUp className="w-8 h-8 text-gray-300" />
                  </div>
                  <h3 className="text-gray-300 text-lg font-semibold mb-2">Connect Google Analytics</h3>
                  <p className="text-gray-400 text-sm mb-4">Get website traffic data and conversion insights</p>
              ...
              delay: 0.7
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-gray-300 text-lg font-semibold mb-2">Connect Search Console</h3>
                  <p className="text-gray-400 text-sm mb-4">Track SEO performance and search rankings</p>
                  <button className="bg-gray-400/20 border border-gray-400/30 rounded-lg px-4 py-2 text-gray-300 text-sm hover:bg-gray-400/30 transition-colors">
                    Connect Console
                  </button>
                </div>
            ...
            duration: 0.6,
            delay: 0.8
          }} className="bg-blue-500/20 backdrop-blur-md border border-blue-400/30 rounded-2xl p-4 mb-8">
              <p className="text-blue-200 text-sm text-center">
                <strong>Note:</strong> Full attribution tracking available after connecting analytics platforms
              </p>
            </motion.div>
            ...
            delay: 0.9
              ...
              <h3 className="text-white text-xl font-semibold mb-6">AI Content Optimization Recommendations</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-xl p-4">
                    <h4 className="text-green-400 font-medium mb-2">CIA Pain Point Analysis</h4>
                    <p className="text-white/80 text-sm">CIA Analysis identified 'customer onboarding friction' - your content addressing this gets 40% higher engagement. Generate 2 more pieces targeting this pain point.</p>
                  </div>
                  
                  <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl p-4">
                    <h4 className="text-blue-400 font-medium mb-2">Authority Positioning Insights</h4>
                    <p className="text-white/80 text-sm">Authority positioning from CIA Phase 1C suggests focusing on 'automation expertise' area. This aligns with your highest-performing content themes.</p>
                  </div>
                </div>
                
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-purple-500/20 to-violet-500/20 border border-purple-500/30 rounded-xl p-4">
                    <h4 className="text-purple-400 font-medium mb-2">Customer Psychology Insights</h4>
                    <p className="text-white/80 text-sm">Customer psychology insights show audience responds best to testimonial-driven content. Your success story format has 3x higher conversion rates.</p>
                  </div>
                  
                  <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl p-4">
                    <h4 className="text-yellow-400 font-medium mb-2">CIA Intelligence Integration</h4>
                    <p className="text-white/80 text-sm">Content with CIA scores above 9.0 generates 65% more authority impact. Focus on deeper intelligence integration for maximum positioning effect.</p>
                  </div>
                </div>
              </div>
            </motion.div>
