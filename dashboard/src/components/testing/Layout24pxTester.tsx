        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className={`font-mono ${gapMeasurements.isCorrect ? 'text-green-400' : 'text-red-400'}`}>
        ...
        >
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <code className="text-purple-300">{JSON.stringify(layoutSystem.spacing.gap.style)}</code>
            </div>
            <div className="flex justify-between">
