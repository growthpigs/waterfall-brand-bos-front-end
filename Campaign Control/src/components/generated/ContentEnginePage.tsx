  ...
  return (
    ...
    >
        ...
        <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50">
          {!chatOpen ? <motion.button onClick={() => setChatOpen(true)} className="w-14 h-14 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white shadow-2xl" whileHover={{
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }}>
              ...
              {!chatMinimized && <>
                  ...
                  <div className="p-4 border-t border-white/20">
                    <div className="flex items-center space-x-2">
                      ...
                      <button onClick={handleSendMessage} className="p-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors">
