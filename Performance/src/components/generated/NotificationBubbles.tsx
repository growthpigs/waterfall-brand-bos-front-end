...
const NotificationBubbles: React.FC = () => {
  ...
  return <div className="relative">
      {/* Notification Button */}
      <motion.button onClick={toggleNotifications} whileHover={{
      scale: 1.05
    }} whileTap={{
      scale: 0.95
        ...
        duration: 0.2
            ...
            <div className="p-4 border-b border-slate-200">
              <div className="flex items-center justify-between">
                ...
                <button onClick={toggleNotifications} className="w-6 h-6 flex items-center justify-center hover:bg-slate-100 rounded-full transition-colors">
            ...
            <div className="max-h-96 overflow-y-auto">
              {notificationList.length === 0 ? <div className="p-8 text-center">
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              ...
                              <button onClick={() => dismissNotification(notification.id)} className="opacity-0 group-hover:opacity-100 w-5 h-5 flex items-center justify-center hover:bg-slate-200 rounded-full transition-all">
            ...
            {/* Footer */}
            {notificationList.length > 0 && <div className="p-3 border-t border-slate-200 bg-slate-50">
                <button onClick={() => setNotificationList([])} className="w-full text-sm text-slate-600 hover:text-slate-900 transition-colors">
