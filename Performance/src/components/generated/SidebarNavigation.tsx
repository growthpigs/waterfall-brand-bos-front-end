...
const SidebarNavigation: React.FC = () => {
  ...
  return <aside className={`${isCollapsed ? 'w-20' : 'w-80'} flex flex-col relative transition-all duration-300 ease-in-out`}>
      {/* Orange/amber glassmorphic overlay for sidebar */}
      <div className="absolute inset-0 bg-gradient-to-b from-orange-600/30 via-amber-700/40 to-orange-800/50 backdrop-blur-md border-r border-orange-400/20" />
      
      {/* Content on top of glassmorphic background */}
      <div className="relative z-10 flex flex-col h-full">
        {/* Header with collapse toggle */}
        <div className="p-6 border-b border-orange-400/20" style={{
        height: "185px",
