...
const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  return <motion.button onClick={onClick} whileHover={{
    ...
    scale: 0.98
      ...
      {/* Logo Icon */}
      <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center" style={{
      background: "linear-gradient(90deg, oklch(0.585 0.233 277.117) 0%, oklch(0.558 0.288 302.321) 100%)",
      display: "none"
    }}>
