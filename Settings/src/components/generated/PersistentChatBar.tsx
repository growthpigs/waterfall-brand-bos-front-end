...
const PersistentChatBar: React.FC<PersistentChatBarProps> = ({
  ...
  return <div className="w-full">
      <form onSubmit={handleSubmit} className="relative">
        <motion.div animate={{
        boxShadow: isFocused ? '0 0 0 2px rgb(255 255 255 / 0.3), 0 8px 32px rgb(255 255 255 / 0.15)' : '0 4px 16px rgb(255 255 255 / 0.08)'
      }} transition={{
        duration: 0.2
        ...
        display: "none"
          ...
          {/* Attachment Button */}
          <button type="button" className="p-4 text-white/70 hover:text-white transition-colors" style={{
          display: "none"
        }}>
